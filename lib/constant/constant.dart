...
class Constant {
  ...
  // Static API key for testing - from settings API: AIzaSyCKCRzqaR1-uzbnEmB-JqVkbUKNGOJHv34
  static String mapAPIKey = "AIzaSyCKCRzqaR1-uzbnEmB-JqVkbUKNGOJHv34";
  ...
  static String orderId({String orderId = ''}) {
    ...
    // Safely get the last 10 characters, or the entire string if shorter
    int startIndex = orderId.length > 10 ? orderId.length - 10 : 0;
    return "#${orderId.substring(startIndex)}";
  }
